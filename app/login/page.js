  ...
  return (
    <>
      <div className="text-white py-14">
        <h1 className="text-5xl items-center text-center  font-bold ">
      ...
      <div className="social-login-buttons"> 
        <div className="flex flex-col gap-2  justify-center items-center  p-10">
          ...
          <button onClick={()=>{signIn("github")}} className="flex items-center  w-72 bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
            <svg
              className="h-6 w-6 mr-2"
              xmlns="http://www.w3.org/2000/svg"
              xmlnsXlink="http://www.w3.org/1999/xlink"
